...
const FunctionalR = ({ onBack }) => {
  ...
  const functionalAcademicAssessments = [
    ...
    },
    {
      ...
      imageUrl: "number-illustration.png",
      bgColor: "#E0F8E8",
      textColor: "#333333"
    },
    {
      ...
      description: "Comprehensive learning assessment.",
      imageUrl: "general-illustration.png",
      bgColor: "#F3E5F5",
      textColor: "#333333"
    },
  ];
        ...
        (snapshot) => {
          ...
          Object.keys(groupedAttempts).forEach(nickname => {
            ...
            studentAttempts.forEach((attempt, index) => {
              ...
              attempt.progress = index > 0 ? 
                (attempt.percentage - studentAttempts[index - 1].percentage) : 0;
  ...
  return (
    <div className="assessment-container">
      <div className="assessment-header">
        ...
        <div className="assessment-main-title">Functional Academics Assessment</div>
        <div className="assessment-subtitle">Track student progress in functional academic skills</div>
      </div>
                ...
                <div className="assessment-card-header">
                  <div className="assessment-card-icon-wrapper">
                    <i className={`assessment-card-icon fas ${
                      assessment.id === "alphabet" ? "fa-spell-check" :
                      assessment.id === "colors" ? "fa-palette" :
                      assessment.id === "shapes" ? "fa-shapes" :
                      assessment.id === "numbers" ? "fa-calculator" :
                      "fa-graduation-cap"
                    }`}></i>
                  </div>
