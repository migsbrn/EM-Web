...
const Prevoc = ({ onBack }) => {
  ...
  const prevocationalSkillsAssessments = [
    {
      id: "general",
      name: "GENERAL PRE-VOCATIONAL ASSESSMENT",
      description: "Assess foundational work readiness and job preparation skills.",
      imageUrl: "general-prevoc-illustration.png",
      bgColor: "#E8F5E8",
      textColor: "#388E3C",
    },
  ]
    ...
    try {
      ...
      const unsubscribe = onSnapshot(
        ...
        (snapshot) => {
          ...
          console.log('Prevoc Assessment Data:', processedAttempts)
          setLoadingAttempts(false)
        },
        (error) => {
  ...
  return (
    <div className="assessment-container">
      <div className="assessment-header">
        ...
        <div className="assessment-main-title">Pre-vocational Skills Assessment</div>
        <div className="assessment-subtitle">Track student progress in foundational work readiness and job skills</div>
      </div>
      ...
      {selectedAssessmentType ? (
        ...
        <div className="assessment-cards-section">
          ...
          <div className="row justify-content-center">
            {prevocationalSkillsAssessments.map((assessment) => (
                ...
                >
                  <div className="assessment-card-header">
                    <div className="assessment-card-icon-wrapper">
                      <i className="assessment-card-icon fas fa-briefcase"></i>
                    </div>
